...
namespace SplineMesh
{
    ...
    public class SplineMeshTiling : MonoBehaviour
    {
        ...
        public void CreateMeshes()
        {
            ...
            if (curveSpace)
            {
                ...
                foreach (var curve in spline.curves)
                {
                    ...
                    if (i == 0)
                        mesh = head;
                    else if (i == spline.nodes.Count - 2)
                        mesh = tail;
                    var go = FindOrCreate("segment " + i++ + " mesh", mesh);
            ...
            {
                var go = FindOrCreate("segment 1 mesh", body);
        ...
        private GameObject FindOrCreate(string name, Mesh mesh)
        {
