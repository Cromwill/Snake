...
public class SnakeDataBaseEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.LabelField("SNAKE DATA BASE", headerTextStyle);
        GUILayout.FlexibleSpace();
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("_defaultSnakeIndex"));
        GUILayout.Space(20);
    ...
    private void RenderElement(SerializedProperty element)
    {
        ...
        EditorGUILayout.PropertyField(element.FindPropertyRelative("_price"));
        EditorGUILayout.PropertyField(element.FindPropertyRelative("_prefab"));
        EditorGUILayout.PropertyField(element.FindPropertyRelative("_previewModel"));

        var sprite = element.FindPropertyRelative("_preview").objectReferenceValue as Sprite;
        var preview = element.FindPropertyRelative("_previewModel").objectReferenceValue as GameObject;
    ...
    private List<int> GetFailedIndexes(SerializedProperty array)
    {
        ...
        for (int i = 0; i < array.arraySize; i++)
        {
            ...
            fieldList.Add(element.FindPropertyRelative("_previewModel").objectReferenceValue);
